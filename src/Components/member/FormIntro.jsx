...
function FormIntro() {
  ...
  useEffect(() => {
    const contentRef = ref(db, "intro"); // Chemin vers la collection
  ...
  return (
    <Box width={{ md: "60%" }} mx={{ md: "auto" }} py={{ md: "16px" }}>
      ...
      <Box mb={4}>
        <small>Rappel : </small>
        <p>
          Ce contenu sera affiché sur la page d'accueil.
        </p>
      </Box>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="6xl">
        ...
        <ModalContent>
          <ModalHeader>
            <Center my={4}>Prévisualisation du texte d'introduction</Center>
          </ModalHeader>
          <ModalBody>
            <Box
